...
import com.jdbcservice.transform.AbstractResponseDataTransformer;
import com.jdbcservice.transform.TransformResultSetAsListOfHashMaps;
 ...
 */
@Log
public abstract class AbstractJDBCQueryExecutor {

    /*   connection jdbc connection and pool details from dbcp pooling */
    public DataSource jdbcPool;


    public List<String> executeQuery(String query, List<String> params, String formatType, QueryType queryType){
    ...
    *   close stmt, return the connection to pool after execution
    ...
    public List<List<List>> executeSelect(String query, List<String> params){
        ...
        try{
            ...
            executeSelectWithConnection(conn, query, params, result, TransformResultSetAsListOfHashMaps.class.getName() );
    ...
    protected void executeSelectWithConnection(Connection conn, String query, List params, List<Object> resultList, String formatType) throws SQLException{
        ...
        try{
            AbstractResponseDataTransformer resultTransformer = AbstractResponseDataTransformer.getResultTransformer(formatType);
