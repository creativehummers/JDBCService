...
@Log
public class MultipleTransaction extends QueryExecutor{

    private AbstractSQLJDBC sqljdbcInstance = null;
    private static QueryExecutionReporter report = new QueryExecutionReporter();

    public static void init(){
        QueryExecutor.register(QueryType.MULTIPLE, MultipleTransaction.class);
    }
    /*
    ...
    public List<String> executeQuery(String multiQueryString, List listOfParams, String formatType) {
        ...
        for( int idx=0; idx < queries.length; idx++){
            ...
            List<String> result = sqljdbcInstance.executeSQL(queries[idx], (List) listOfParams.get(0), formatType,queryType);
